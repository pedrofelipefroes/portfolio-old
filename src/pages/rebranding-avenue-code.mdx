...
order: 1
featuredImage: ../images/rebranding-avenue-code/Cover - Artwork featuring a subway map with stations named after Avenue Code practice areas.cover.jpg
highlightColor: FF5166
title: Rebranding Avenue Code
headline: Brand Design done in a cohesive, scalable way.
...
activity: Branding & Visual Design
...
### _How Might We_ redesign Avenue Code brand to become more scalable yet cohesive to the company’s spirit?
...
<ImgContainer
  ...
  image={
    <>
      <Img alt={props.img.alt(0)} fluid={props.img.src(0)} />
...
<ImgContainer
  ...
  image={
    <>
      ...
      <Fade bottom>
        <Img alt={props.img.alt(4)} fluid={props.img.src(4)} class="p-rebranding-avenue-code__mood-board-overlay" />
      </Fade>
    </>
  }
/>
...
<ImgContainer
  ...
  image={
    <>
      <Img alt={props.img.alt(5)} fluid={props.img.src(5)} />
